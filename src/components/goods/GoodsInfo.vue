  ...
  <div class="goodsinfo-container">
    ...
    <div class="mui-card">
      ...
      <div class="mui-card-footer">
        <mt-button type="primary" size="large" plain @click="">图文介绍</mt-button>
        <mt-button type="danger" size="large" plain @click="">商品评论</mt-button>
      </div>
    </div>
...
import goodslunbojson from "../../json/goodslunbo.json";
import goodsinfojson from "../../json/goodsinfo.json";
...
export default {
  ...
  methods: {
  	getLunbotu(){
          ...
          goodslunbojson.message.forEach(item => {
            item.img = item.src;
          });
          this.lunbotu = goodslunbojson.message;
        }
    },
    getGoodsInfo() {
      // 获取商品的信息
